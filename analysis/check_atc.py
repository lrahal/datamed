...
def get_diff_atc():
    ...
    b = dfv.groupby(
        ['cis', 'denomination_specialite', 'atc']).count().reset_index()[['cis', 'denomination_specialite', 'atc']]
    b = b.rename(columns={'denomination_specialite': 'specialite_ventes', 'atc': 'atc_ventes'})
