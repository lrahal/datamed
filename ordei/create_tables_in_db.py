...
def save_to_database_orm(session):
    ...
    corresp_spe_prod_subs = corresp_spe_prod_subs.rename(
        columns={'SPECIALITE_CODEX': 'specialite_codex', 'PRODUIT_CODEX': 'produit_codex',
                 'SUBSTANCE_CODEX_UNIQUE': 'substance_codex_unique', 'codeSubstance': 'code'}
    )
    ...
    corresp_prod_subs = corresp_prod_subs[['produit_codex', 'substance_codex_unique', 'code']].sort_values(
        by=['produit_codex'])
    ...
    bnpv_open_medic1418_prod_codex = pd.read_csv(
        ...
        sep=';')
    bnpv_open_medic1418_prod_codex = bnpv_open_medic1418_prod_codex.drop('Unnamed: 0', axis=1)

    bnpv_open_medic1418_prod_codex = bnpv_open_medic1418_prod_codex.rename(
        columns={'ANNEE': 'annee', 'SEXE': 'sexe', 'AGE': 'age', 'PRODUIT_CODEX': 'produit_codex'}
    )
    ...
    bnpv_eff_soclong_prod_codex_open = pd.read_csv(
        ...
        sep=';')
    bnpv_eff_soclong_prod_codex_open = bnpv_eff_soclong_prod_codex_open.drop('Unnamed: 0', axis=1)

    bnpv_eff_soclong_prod_codex_open = bnpv_eff_soclong_prod_codex_open.rename(
        columns={'SEXE': 'sexe', 'AGE': 'age', 'SOC_LONG': 'soc_long', 'PRODUIT_CODEX': 'produit_codex'}
    )
    ...
    bnpv_eff_hlt_prod_codex_open = pd.read_csv(
        ...
        encoding='ISO-8859-1', sep=';')
    bnpv_eff_hlt_prod_codex_open = bnpv_eff_hlt_prod_codex_open.drop('Unnamed: 0', axis=1)

    bnpv_eff_hlt_prod_codex_open = bnpv_eff_hlt_prod_codex_open.rename(
        columns={'SEXE': 'sexe', 'AGE': 'age', 'EFFET_HLT': 'effet_hlt',
                 'SOC_LONG': 'soc_long', 'PRODUIT_CODEX': 'produit_codex'}
    )
    ...
    bnpv_notif_prod_codex_open = bnpv_notif_prod_codex_open.rename(
        columns={'TYP_NOTIF': 'typ_notif', 'SEXE': 'sexe', 'AGE': 'age', 'PRODUIT_CODEX': 'produit_codex'}
    )
    ...
    bnpv_open_medic1418_sa_codex = bnpv_open_medic1418_sa_codex.drop('Unnamed: 0', axis=1)

    bnpv_open_medic1418_sa_codex = bnpv_open_medic1418_sa_codex.rename(
        columns={'ANNEE': 'annee', 'SEXE': 'sexe', 'AGE': 'age',
                 'SUBSTANCE_CODEX_UNIQUE': 'substance_codex_unique', 'codeSubstance': 'code'}
    )
    ...
    bnpv_eff_soclong_sa_codex_open = bnpv_eff_soclong_sa_codex_open.rename(
        columns={'SEXE': 'sexe', 'AGE': 'age', 'SOC_LONG': 'soc_long',
                 'SUBSTANCE_CODEX_UNIQUE': 'substance_codex_unique', 'codeSubstance': 'code'}
    )
    ...
    bnpv_eff_hlt_sa_codex_open = bnpv_eff_hlt_sa_codex_open.rename(
        columns={'SEXE': 'sexe', 'AGE': 'age', 'EFFET_HLT': 'effet_hlt', 'SOC_LONG': 'soc_long',
                 'SUBSTANCE_CODEX_UNIQUE': 'substance_codex_unique', 'codeSubstance': 'code'}
    )
    ...
    bnpv_notif_sa_codex_open = bnpv_notif_sa_codex_open.rename(
        columns={'TYP_NOTIF': 'typ_notif', 'SEXE': 'sexe', 'AGE': 'age',
                 'SUBSTANCE_CODEX_UNIQUE': 'substance_codex_unique', 'codeSubstance': 'code'}
    )
